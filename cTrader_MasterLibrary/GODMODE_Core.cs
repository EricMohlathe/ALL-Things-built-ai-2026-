// ============================================================================
//  GODMODE_Core.cs  —  Shared engine for the GODMODE Master cBot Library
//  (cTrader / cAlgo, C#)
//
//  Mirror of the MT5 library's GODMODE_Core.mqh. Every archetype cBot uses
//  these classes: risk-based sizing (tuned for $10-$100 accounts), session
//  clock, daily kill-switches, trade management, a CSV journal that logs
//  ENTRIES *and* SKIPS, and SMC structure helpers (FVG / order block).
//
//  HOW TO USE IN cAlgo:
//   Option A (recommended): create a cBot, then add this file to the SAME
//     cBot project (Solution explorer -> Add -> Existing item). Repeat per cBot,
//     or keep all 9 cBots + this file in one cAlgo project.
//   Option B: compile this as a referenced class library.
//  Each cBot does:  using GODMODE.Core;
// ============================================================================
using System;
using System.IO;
using System.Linq;
