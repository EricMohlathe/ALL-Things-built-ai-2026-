...
version: 2.1
author: GODMODE SYNTHESIS — 69+ PDFs + 10 HTML curriculum files (33 videos, Fabio Valentini encyclopedia)
description: >
  GODMODE Order Flow Trading Mastery Expert Skill v2.1. Complete institutional-grade
  order flow framework for building EA trading robots on MetaTrader 5 (MQL5) and
  cTrader (cAlgo/C#). Synthesizes Fabio Valentini AMT methodology (35 videos, ChartFanatics),
  Wyckoff 2.0 (Fractal Flow), Volume Profile, Footprint/Delta analysis, SMC/ICT framework,
  all Pine Script indicator logic, full language conversion tables, and 7 reference files
  covering 33-video curriculum, 200+ term glossary, 12 graded setups, and MQL5 code modules.
  Primary purpose: enable production EA generation for MT5 and cTrader.
references:
  - "refs/ORDERFLOW DIVE 2.0.md"
  - refs/REF-01-VIDEO-CURRICULUM.md
  - refs/REF-02-MASTER-GUIDE.md
  - refs/REF-03-ADVANCED-GLOSSARY.md
  - refs/REF-04-FABIO-VALENTINI-ENCYCLOPEDIA.md
  - refs/REF-05-WYCKOFF-DEEPDIVE.md
  - refs/REF-06-83MIN-OFT-COURSE.md
  - refs/REF-07-DARIUS-FX-FOUNDATIONS.md
triggers:
  - "order flow EA"
  - "cTrader bot"
  - "MT5 robot"
...
# GODMODE ORDER FLOW TRADING MASTERY EXPERT SKILL v2.0
...
## PART 11: REFERENCE LIBRARY — HTML SOURCE INTEGRATIONS

> 7 deep-dive MD reference files synthesized from the GODMODE HTML curriculum (33-video series, Fabio Valentini Encyclopedia, Advanced Glossary). Load these references for deeper context on any topic.

### Reference File Index

| File | Content | When to Load |
|------|---------|-------------|
| `refs/REF-01-VIDEO-CURRICULUM.md` | Complete 33-video index with grades, topics, channel profiles, concept routing, learning paths | When routing to specific video concepts or building curriculum |
| `refs/REF-02-MASTER-GUIDE.md` | 12-part institutional framework: OF Foundations, VP Mastery, Market Structure, SMC/ICT, Liquidity, Wyckoff/AMT, Advanced Tools, Algo, Live Trading, ChartFanatics System, Synthesis | Comprehensive setup-building reference; when designing full trading systems |
| `refs/REF-03-ADVANCED-GLOSSARY.md` | 200+ term glossary (OF, VP, SMC/ICT, Wyckoff), 12 graded trade setups (A+/A/B), 6 risk frameworks, 40-question self-assessment with answers | When generating setups, defining signals, building risk logic |
| `refs/REF-04-FABIO-VALENTINI-ENCYCLOPEDIA.md` | Complete Fabio Valentini/ChartFanatics/Fabervaale AMT system: 35 videos, Triple-A framework, Model 1 & 2, LVN playbook, session timing, 5 MQL5 code modules, daily checklists | **Primary EA building reference** — use for MT5/cTrader AMT-based automation |
| `refs/REF-05-WYCKOFF-DEEPDIVE.md` | Fractal Flow Wyckoff course: 5-phase accumulation/distribution, Spring anatomy, modern OF integration, entry protocols, distribution mirror | When implementing Wyckoff Spring or accumulation/distribution detection in EA |
| `refs/REF-06-83MIN-OFT-COURSE.md` | Mind Math Money systematic OFT: 5 footprint signals, statistical framework (0.94R expectancy), position sizing, decision tree, EA signal logic | When building signal detection logic and backtesting framework |
| `refs/REF-07-DARIUS-FX-FOUNDATIONS.md` | Darius FX definitive OF guide: bid-ask mechanics, delta matrix, CVD patterns, footprint deep dive, iceberg/spoof detection, 5-step reading process, signal cheat sheet | When implementing fundamental OF signal reading logic |

### Quick Concept → Reference Routing

| Concept | Primary Ref | Secondary Ref |
|---------|------------|--------------|
| AMT / Market State Classification | REF-04 (§02, §08) | REF-02 (§Part01) |
| Model 1 (Trend Continuation) | REF-04 (§11) | REF-02 (§Part12) |
| Model 2 (Mean Reversion) | REF-04 (§12) | REF-03 (Setup 5) |
| Triple-A Framework | REF-04 (§09) | REF-02 (§Part01) |
| Absorption Detection | REF-07 (§Pattern 1) | REF-04 (§09) |
| CVD Signals & Divergence | REF-07 (§3) | REF-04 (§05) |
| Footprint Reading | REF-07 (§4) | REF-06 (§3) |
| Delta Matrix | REF-07 (§2) | REF-03 (Glossary) |
| Volume Profile Setup | REF-04 (§04) | REF-02 (§Part02) |
| LVN Execution | REF-04 (§13) | REF-02 (§Part02) |
| Wyckoff Spring Entry | REF-05 (§4) | REF-03 (Setup 3) |
| Wyckoff Accumulation Phases | REF-05 (§2) | REF-02 (§Part06) |
| Session Timing | REF-04 (§14) | REF-03 (§Framework 5) |
| Stop Loss Placement | REF-04 (§15) | REF-06 (§4) |
| 12 Trade Setups (A+/A/B) | REF-03 (§Section 3) | REF-02 (§Part12) |
| Position Sizing Formula | REF-04 (§17) | REF-06 (§4) |
| MQL5 Code Modules | REF-04 (§23) | SKILL.md Part 5 |
| Pre-Trade Checklists | REF-04 (§24) | REF-06 (§5) |
| 33 Video Curriculum | REF-01 (full) | REF-02 (Part 11) |
| SMC / ICT Framework | REF-02 (§Part04) | REF-03 (Glossary) |
| Liquidity Concepts | REF-02 (§Part05) | REF-03 (Glossary) |
| Prop Firm Protocol | REF-04 (§20) | REF-03 (§Framework 3) |
| Risk Frameworks | REF-03 (§Section 4) | REF-04 (§17) |
| EA Implementation Signal Logic | REF-06 (§8) | REF-04 (§23) |
| Statistics / Expectancy | REF-06 (§2) | REF-04 (§21) |

### Integration Notes
- **For EA building (MT5 MQL5)**: Load REF-04 → SKILL.md Part 5 → REF-06 §8
- **For EA building (cTrader cAlgo)**: Load REF-04 → SKILL.md Part 5.2 → REF-07 §5
- **For strategy design**: Load REF-03 §Section 3 → REF-02 §Part12 → REF-04 §11/§12
- **For signal detection**: Load REF-07 §4 → REF-06 §3 → REF-04 §06
- **For risk management**: Load REF-03 §Section 4 → REF-04 §17 → REF-06 §4

---

*GODMODE ORDER FLOW MASTERY SKILL v2.1 — All sources synthesized*
*Source documents: 69+ PDFs + 10 HTML GODMODE curriculum files (33 videos, Fabio Valentini encyclopedia)*
*Primary: Fabio Valentini AMT | Wyckoff 2.0 Villahermosa | JacobS369 Absorption*
*Supporting: Carmine LVN | Trader Dale VP | Darius FX | Fractal Flow | Mind Math Money | Chart Fanatics*
*Reference library: 7 MD files in refs/ directory | Updated: April 2026*
